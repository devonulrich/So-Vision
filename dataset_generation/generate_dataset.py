...
cartoon_set_path = "../personai_icartoonface_rectrain/icartoonface_rectrain"
real_set_path = "../fddb"
...
def generate_dataset():
    ...
    cartoon_image_descriptors = np.genfromtxt("../personai_icartoonface_rectrain/icartoonface_rectrain_det.txt", dtype=str, delimiter="\n", encoding="utf-8")
